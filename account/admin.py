...
class UserAdmin(BaseUserAdmin):
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'password1', 'password2','groups' , 'is_staff', 'is_active', 'is_superuser','created_by')}
        ),
    )

    fieldsets = (
        (None, {'fields': ('email', 'password')}),
        ('Permissions', {'fields': ('type','groups','is_staff', 'is_active','is_superuser','is_status','created_by')}),
    )
